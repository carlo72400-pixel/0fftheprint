...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  /* ⛔ THE TILE IS A FIXED 9:16 NOW, so a rail cannot go ragged. The 28 vertical
     posters fit it exactly. The 7 landscape night clips are COVER cropped rather
     than letterboxed, because a bar-boxed tile in a uniform rail reads as broken;
     the uncropped frame is one tap away in the lightbox, which never crops. */
